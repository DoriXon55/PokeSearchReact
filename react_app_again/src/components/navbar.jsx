  ...
  return (
    <nav className={`${darkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'} shadow-md`}>
      ...
      <Link to="/" className="flex items-center">
          <img 
            src="src/assets/website_logo.svg" 
            alt="Pokeball"
            className="h-8 w-8 mr-2" 
          />
          <h1 className="text-xl font-bold text-red-600 dark:text-red-400">Pokédex</h1>
        </Link>
      
        
        <div className="flex items-center space-x-4">
          <Link to="/" className={`${darkMode ? 'text-gray-300 hover:text-red-400' : 'text-gray-700 hover:text-red-600'}`}>
            Home
          </Link>
          <button
